...
function App() {
  ...
  const containerQuery = (0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(null); //Using useEffect hook I am calling a function to generate the colours and return them in an array;
...
app.use((rec, res) => {
  const html = (0,react_dom_server__WEBPACK_IMPORTED_MODULE_2__.renderToString)( /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1__.createElement(_App__WEBPACK_IMPORTED_MODULE_3__["default"], null));
  res.send(`
    <!DOCTYPE html>
<html lang='en'>
  <head>
